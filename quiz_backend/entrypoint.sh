...
# Пропускаем загрузку иконок для быстрого старта
# Если иконки нужны - запустите вручную: python manage.py fix_icon_mapping
...
if [ "$DEBUG" = "True" ]; then
    ...
    # Рассчитываем оптимальное количество workers (по умолчанию 1 для критически слабых серверов)
