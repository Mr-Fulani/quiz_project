    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(blank=True, db_column='group_id', help_text='Связанная группа/канал', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tasks', to='platforms.telegramgroup')),
