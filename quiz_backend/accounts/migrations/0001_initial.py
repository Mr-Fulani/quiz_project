# Generated by Django 5.1.4 on 2025-05-01 18:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_django_admin', models.BooleanField(default=False, verbose_name='Django Admin')),
                ('is_super_admin', models.BooleanField(default=False, verbose_name='Super Admin')),
                ('groups', models.ManyToManyField(blank=True, related_name='%(app_label)s_%(class)s_set', related_query_name='%(app_label)s_%(class)s', to='auth.group', verbose_name='groups')),
                ('user_permissions', models.ManyToManyField(blank=True, related_name='%(app_label)s_%(class)s_permissions', related_query_name='%(app_label)s_%(class)s', to='auth.permission', verbose_name='user permissions')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(blank=True, related_name='telegram_admins', to='platforms.telegramgroup', verbose_name='Telegram Группа/Канал')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telegram_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='channel_subscriptions', to='accounts.telegramuser', verbose_name='Telegram пользователь')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='channel_subscriptions', to=settings.AUTH_USER_MODEL, verbose_name='Пользователь сайта')),
            ],
            options={
