    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_permissions', models.ManyToManyField(blank=True, help_text='Индивидуальные разрешения пользователя.', related_name='customuser_permissions', to='auth.permission', verbose_name='Разрешения')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('channel', models.ForeignKey(db_column='channel_id', on_delete=django.db.models.deletion.CASCADE, related_name='user_subscriptions', to='platforms.telegramchannel', to_field='group_id', verbose_name='Канал')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='channel_subscriptions', to=settings.AUTH_USER_MODEL, verbose_name='Пользователь')),
            ],
            options={
