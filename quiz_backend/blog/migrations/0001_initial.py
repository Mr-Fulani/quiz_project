...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('text', models.CharField(blank=True, help_text='Основной текст (используется как запасной)', max_length=255)),
                ('text_en', models.CharField(blank=True, max_length=255, verbose_name='Текст (английский)')),
                ('text_ru', models.CharField(blank=True, max_length=255, verbose_name='Текст (русский)')),
                ('text_es', models.CharField(blank=True, max_length=255, verbose_name='Текст (испанский)')),
                ('text_fr', models.CharField(blank=True, max_length=255, verbose_name='Текст (французский)')),
                ('text_de', models.CharField(blank=True, max_length=255, verbose_name='Текст (немецкий)')),
                ('text_zh', models.CharField(blank=True, max_length=255, verbose_name='Текст (китайский)')),
                ('text_ja', models.CharField(blank=True, max_length=255, verbose_name='Текст (японский)')),
                ('text_tj', models.CharField(blank=True, max_length=255, verbose_name='Текст (таджикский)')),
                ('text_tr', models.CharField(blank=True, max_length=255, verbose_name='Текст (турецкий)')),
                ('text_ar', models.CharField(blank=True, max_length=255, verbose_name='Текст (арабский)')),
                ('is_active', models.BooleanField(default=False, verbose_name='Активно')),
                ('link_url', models.CharField(blank=True, help_text='URL для ссылки (поддерживает http/https и Telegram-ссылки: tg://resolve?domain@username)', max_length=200, validators=[blog.models.CustomURLValidator()], verbose_name='URL ссылки')),
                ('link_target_blank', models.BooleanField(default=False, verbose_name='Открывать ссылку в новой вкладке')),
                ('order', models.PositiveIntegerField(default=0, help_text='Число, определяющее порядок строки (меньше — выше).', verbose_name='Порядок отображения')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', tinymce.models.HTMLField(verbose_name='Содержимое поста')),
                ('excerpt', tinymce.models.HTMLField(blank=True, verbose_name='Краткое описание')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alt_text', models.CharField(blank=True, help_text='Текст, который будет отображаться, если изображение не загрузится. Важно для SEO.', max_length=255, verbose_name='Alt текст')),
