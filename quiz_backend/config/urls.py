...
urlpatterns = [
    ...
    path('share/post/<slug:slug>/', RedirectView.as_view(url='/ru/post/%(slug)s/', permanent=False), name='share_post_no_lang'),
    path('share/project/<slug:slug>/', RedirectView.as_view(url='/ru/project/%(slug)s/', permanent=False), name='share_project_no_lang'),    
