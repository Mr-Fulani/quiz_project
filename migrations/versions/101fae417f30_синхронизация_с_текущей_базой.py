"""Синхронизация с текущей базой

Revision ID: 101fae417f30
Revises: 0dbe63ee11af
Create Date: 2025-01-18 11:36:01.443791
...
revision: str = '101fae417f30'
down_revision: Union[str, None] = '0dbe63ee11af'
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['task_id'], ['tasks.id'], name='task_statistics_task_id_58414696_fk_tasks_id', initially='DEFERRED', deferrable=True),
    ...
    sa.Column('task_id', sa.BIGINT(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['task_id'], ['tasks.id'], name='task_translations_task_id_95d14cb3_fk_tasks_id', initially='DEFERRED', deferrable=True),
