...
STATIC_VERSIONS = {
    ...
    'topic-cards.js': '1.5',
    'topic-detail.js': '1.6',
    'top_users.js': '18.1',  # Добавлена отладочная информация для кнопки сброса
    ...
    'profile.js': '5.1',  # Добавлено детальное логирование и принудительное обновление технологий
    'top_users.css': '23.1',  # Исправлены фильтры и кнопка сброса на продакшене
