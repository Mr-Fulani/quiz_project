...
STATIC_VERSIONS = {
    ...
    'share-topic.js': '1.7',  # FIX: Убраны кнопки поделиться из карусели карточек на главной странице
    'share-topic.css': '1.7',  # FIX: Убраны кнопки поделиться из карусели карточек на главной странице
    'topic-cards.js': '2.7',  # FIX: Убраны кнопки поделиться из карусели карточек на главной странице
}
