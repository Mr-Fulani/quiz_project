...
STATIC_VERSIONS = {
    ...
    'tasks.js': '3.14',  # FIX: Добавлена поддержка форматирования ссылок и отображения источников в объяснениях
    ...
    'styles.css': '4.1',  # Добавлено сенсорное управление основной каруселью тем
    ...
    'tasks.css': '1.2',  # FIX: Добавлены стили для источников объяснений и ссылок
    ...
    'topic-cards.js': '3.0',  # Исправлено открытие карточки обычным тапом после добавления свайпа
