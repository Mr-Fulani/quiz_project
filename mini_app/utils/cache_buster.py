...
STATIC_VERSIONS = {
    ...
    'tasks.js': '3.13',  # FIX: Кнопка "Не знаю" переключает объяснение без показа сообщения об ошибке
    'topic-cards.js': '2.5',  # Добавлено программное воспроизведение видео при открытии увеличенной карточки
    'topic-detail.js': '1.6',
    'top_users.js': '30.6',  # FIX: Исправлена логика восстановления модального окна - теперь полагаемся на sessionStorage вместо referrer (для SPA навигации)
    'user_profile.js': '2.6',  # FIX: Использована SPA навигация вместо полной перезагрузки для быстрого возврата в топ юзеров
    ...
    'styles.css': '4.0',  # FIX: Иконка не двигается без ползунка - убраны hover эффекты, движение только с классом active
    ...
    'tasks.css': '1.1',  # FIX: Обновлены стили для объяснений (нумерация списков, форматирование)
    'settings.css': '6.2',  # Добавлена подсказка об изображениях
    'feedback.js': '2.7',  # Добавлено динамическое позиционирование формы при появлении клавиатуры
    ...
    'comments.js': '4.2',  # FIX: Исправлен перевод текста кнопки отправки комментария - теперь "Sending..." / "Отправка..." и "Send" / "Отправить" переводятся в зависимости от языка приложения
