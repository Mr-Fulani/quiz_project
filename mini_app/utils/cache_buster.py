...
STATIC_VERSIONS = {
    ...
    'topic_detail.css': '1.2',  # Добавлено название темы рядом с кнопкой "Назад", обновлены стили page-header
    ...
    'comments.js': '2.7',  # FIX: Добавлена поддержка языка пользователя для локализации времени комментариев
    'comments.css': '2.2',  # Улучшены стили: время с фоном, лучшая читаемость, адаптивность
}
