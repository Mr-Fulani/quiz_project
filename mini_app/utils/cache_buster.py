...
STATIC_VERSIONS = {
    ...
    'topic-cards.js': '1.5',
    'topic-detail.js': '1.6',
    'top_users.js': '24.4',  # ФИКС: добавлен класс .active при открытии/закрытии модального окна для применения flex-стилей
    ...
    'top_users.css': '31.5',  # Исправлен flex для корректной работы padding
    'top_users_swiper.css': '19.0',  # ФИКС: модальное окно теперь действительно адаптивно - flex-контейнеры с height:100%, min-height вместо max-height, убраны ограничения
