...
STATIC_VERSIONS = {
    ...
    'share-app.js': '1.8',
    'profile.js': '25.0',  # Создано кастомное поле ProgrammingLanguageIdsField
    'search.js': '1.7',
    'tasks.js': '3.11',
    'topic-cards.js': '1.5',
    'topic-detail.js': '1.6',
    ...
    'profile.js': '2.7',  # Возвращен правильный URL API для получения профиля по telegram_id
    'top_users.css': '23.0',  # Добавлена интерактивность карточек пользователей (cursor: pointer, hover/active эффекты)
