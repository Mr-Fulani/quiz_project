...
STATIC_VERSIONS = {
    ...
    'topic-cards.js': '1.5',
    'topic-detail.js': '1.6',
    'top_users.js': '24.3',  # Удалена конфигурация пагинации Swiper (убрана прозрачная полоса)
    ...
    'top_users.css': '25.1',  # Обновлен для исправления конфликта скриптов
    'top_users_swiper.css': '10.4',  # Максимально компактная карточка: отступы 100-160px, карточка занимает ~60-65% высоты экрана
