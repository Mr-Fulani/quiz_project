...
STATIC_VERSIONS = {
    ...
    'topic-cards.js': '1.5',
    'topic-detail.js': '1.6',
    'top_users.js': '27.4',  # Использование viewport units (50vh/50vw) для абсолютного центрирования
    ...
    'donation.css': '1.2',  # Центрирование всплывающих уведомлений с учетом Safe Areas Telegram
    ...
    'top_users_swiper.css': '24.3',  # Viewport units + inset:unset для изоляции от родительских контекстов
