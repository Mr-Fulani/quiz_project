...
STATIC_VERSIONS = {
    ...
    'comments.js': '2.8',  # Упрощена структура: все ответы на level 1, добавлена индикация "@username"
    'comments.css': '2.3',  # Упрощена вложенность, добавлены стили для reply-to индикатора
}
