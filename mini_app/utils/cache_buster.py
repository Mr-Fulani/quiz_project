...
STATIC_VERSIONS = {
    ...
    'topic-cards.js': '1.5',
    'topic-detail.js': '1.6',
    'top_users.js': '26.2',  # Исправлено: используются классы вместо inline стилей для кнопки "Все пользователи"
    ...
    'styles.css': '1.7',  # Исправлено центрирование карточек карусели с учетом Safe Areas  # Safe Area исправления для Telegram Mini App - исправлено перекрытие элементов
    'donation.css': '1.1',  # Исправлено центрирование сообщений о статусе платежа с Safe Areas
    'profile.css': '8.1',  # Исправлен фон карточки профессиональной информации - теперь черный как у других карточек
    'profile.js': '5.3',  # Добавлен метод get_programming_languages в сериализатор
    'top_users.css': '31.7',  # Убран SVG фильтр, увеличены размеры кнопки, явная видимость
    'top_users_swiper.css': '23.8',  # Исправлена загрузка - теперь permanent, не сбрасывается при навигации
    ...
    'topic_detail.css': '1.0',  # Унификация кэширования
