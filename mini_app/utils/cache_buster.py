...
STATIC_VERSIONS = {
    ...
    'topic-cards.js': '1.5',
    'topic-detail.js': '1.6',
    'top_users.js': '24.2',  # Исправлено: блокировка скролла, восстановление стилей, закрытие по ESC
    ...
    'top_users_swiper.css': '7.8',  # Полностью переписан с clamp(), env(), safe-area, адаптивность для всех платформ
