...
STATIC_VERSIONS = {
    ...
    'donation.css': '2.1',  # FIX: Корректное позиционирование с учетом Safe Areas
    ...
    'comments.js': '3.3',  # Добавлено динамическое позиционирование формы при появлении клавиатуры
